...
public static class Strings
{
    ...
    public const string OpenApiInfoProjectVersion = "1.1";
    ...
    public const string SwaggerEndpoint = $"/swagger/{OpenApiInfoProjectVersion}/swagger.json";
    public const string GithubContactName = "Github Repository";
