...
namespace SeoulAir.Device.Api.Controllers
{
    ...
    public class AirQualitySensorController : Controller
    {
        ...
        /// <response code="200">Sensor started</response>
        ...
        /// <response code="200">Sensor not working anymore</response>
        [ProducesResponseType(StatusCodes.Status200OK)]
        [HttpPut]
        ...
        [HttpGet]
        public IActionResult LastMeasuredData()
        {
        ...
        /// <response code="200">Name changed successfully.</response>
        ...
        /// <response code="200">Delay is changed to new value.</response>
